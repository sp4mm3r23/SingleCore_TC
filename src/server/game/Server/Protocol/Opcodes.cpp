...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_CHECK_WOW_TOKEN_VETERAN_ELIGIBILITY,                STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleWowTokenCheckVeteranEligibility);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_WOW_TOKEN_MARKET_PRICE,                     STATUS_AUTHED,    PROCESS_INPLACE, &WorldSession::HandleRequestWowTokenMarketPrice);
    ...
    DEFINE_HANDLER(CMSG_UPDATE_VAS_PURCHASE_STATES,                         STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleBattlePayUpdateVasPurchaseStates);
    DEFINE_HANDLER(CMSG_UPDATE_WOW_TOKEN_AUCTIONABLE_LIST,                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateListedAuctionableTokens);
