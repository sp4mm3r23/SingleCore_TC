...
namespace ahbot
{
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_QUEST;
        }
        ...
        virtual uint32 GetStackCount(ItemTemplate const* proto)
        {
            ...
            uint32 maxStackSize = proto->GetMaxStackSize();
            if (proto->GetQuality == ITEM_QUALITY_UNCOMMON && maxStackSize > 10)
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_TRADE_GOODS;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_PERMANENT && proto->ItemLevel > 1;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_REAGENT && proto->ItemLevel > 1;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_RECIPE && proto->ItemLevel > 1;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return (proto->GetClass == ITEM_CLASS_WEAPON ||
                proto->GetClass == ITEM_CLASS_ARMOR) && proto->ItemLevel > 1;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetQuality > ITEM_QUALITY_POOR && (
                proto->GetClass == ITEM_CLASS_MISC ||
                proto->GetClass == ITEM_CLASS_GENERIC ||
                proto->GetClass == ITEM_CLASS_MONEY) && proto->ItemLevel > 1 && proto->SubClass != ITEM_SUBCLASS_JUNK_MOUNT;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_QUIVER && proto->ItemLevel > 1;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_PROJECTILE;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_CONTAINER && proto->ItemLevel > 1;
        }
    ...
    public:
        virtual bool Contains(ItemTemplate const* proto)
        {
            return proto->GetClass == ITEM_CLASS_GLYPH;
        }
